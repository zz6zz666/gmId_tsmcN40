...
Print["  4-D \:53d8\:91cf\:4e2a\:6570 = ", Length[vars4],
  ", \:7ef4\:5ea6 (L,VGS,VDS,VSB) = ", Dimensions[tt[vars4[[1]]]]];
Print["  ===== ===== ===== ===== ===== ===== ===== ===== ===== ===== ===="];
...
(* =====================================================================
   ...
   ===================================================================== *)
Print[ListLinePlot[fam[tt, "GM_ID", 0, 0.55, Ls], DataRange -> {0, 1.1},
...
(* =====================================================================
   ...
   ===================================================================== *)
Print[ListLogPlot[fam[tt, "ID", 0, 0.55, Ls], DataRange -> {0, 1.1},
  PlotStyle -> cols, PlotLegends -> legend[Ls],
...
Print[With[{fi = N40Interpolant[tt, "ID"], vd = tt["VDS"]},
  ListLinePlot[
...
(* =====================================================================
   ...
   ===================================================================== *)
Print[With[{fg = N40Interpolant[tt, "CGG"], fs = N40Interpolant[tt, "CGS"],
...
(* =====================================================================
   ...
   ===================================================================== *)
Print[ListLinePlot[fam[tt, "VDSAT", 0, 0.55, Ls], DataRange -> {0, 1.1},
  PlotStyle -> cols, PlotLegends -> legend[Ls],
...
(* =====================================================================
   ...
   ===================================================================== *)
Print[With[{fi = N40Interpolant[tt, "ID"], vsbs = {0.0, 0.2, 0.4, 0.6, 0.8}},
  ListLogPlot[
...
(* =====================================================================
   ...
   ===================================================================== *)
Print[With[{f = N40Interpolant[tt, "GM_ID"]},
  ListContourPlot[
...
(* =====================================================================
   ...
   ===================================================================== *)
Print[With[{fs = N40Interpolant[tt, "STH"], fl = N40Interpolant[tt, "SFL"]},
  ListLinePlot[{
    Map[fs[0.1, #, 0.55, 0] &, vgs],
